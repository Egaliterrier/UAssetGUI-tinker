...
public partial class DirectoryTreeItem : ObservableObject
{
    ...
    private UAsset TryBuildAssetInMemory()
    {
        ...
        var uassetFile = GameFiles.FirstOrDefault(f => f.Extension.Equals("uasset", StringComparison.OrdinalIgnoreCase));
        if (uassetFile == null) throw new FileNotFoundException("Asset file (.uasset) not found in game files.");
